...
Funcionalidade: Users
  ...
  Cenario: Cadastro de usuario
    ...
    E valido que o campo "email" retornou o valor "thiago@email.com"
    E valido que o campo "password" retornou o valor "teste123"
  ...
  Cenario: Update de usuario
    ...
    Entao o sistema devolve o status 200
    E valido que o campo "email" retornou o valor "thiago2@email.com"
    E valido que o campo "password" retornou o valor "teste1234"